...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.img = pg.transform.rotozoom(pg.image.load(f"beam.png"), math.degrees(math.atan2(-self.vy,self.vx)), 0.9)
...
class explosion():
    ...
    def __init__(self, bomb:"Bomb"):
        ...
        爆発gifの表示
        """
        self.imgb = pg.transform.rotozoom(pg.image.load("explosion.gif"), 0, 1.0)
